                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="status" id="akses_id" class="form-control" required <option
