        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">test Form Konsesi</h1>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="int" class="form-control" placeholder="Masukkan No" name="id_konsesi" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Masukkan Kode Material" name="kode_material" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="status" id="akses_id" class="form-control" required <option value="Open">Open</option>
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="date-end ml-5 form-control datepicker col-sm-8" placeholder="Masukkan Tanggal Datang" name="tgl_matrial_dtg" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="date-end ml-5 form-control datepicker col-sm-8" placeholder="Masukkan Tanggal Pasang" name="tgl_pasang" required>
                                        </div>
                                    </div>
                                </div>
