                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="id" id="statdrop" required
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="date-end ml-5 form-control datepicker col-sm-8"
                                                placeholder="Masukan Waktu Start" name="nesting_start" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 py-3">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="date-end ml-5 form-control datepicker col-sm-8"
                                                placeholder="Masukan Waktu End" name="nesting_end" required>
                                        </div>
                                    </div>
                                </div>
